...
#define GETTEXT_PACKAGE "mousepad"
...
/* Define if polkit-gobject-1 >= polkit_min_version present */
/* #undef HAVE_POLKIT */
...
#define PACKAGE_BUGREPORT "https://gitlab.xfce.org/apps/mousepad"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mousepad"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mousepad 0.6.1"
