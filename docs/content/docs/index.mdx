...
Dynamic Apps runs user-generated HTTP applications on Rivet. Apps can add
...
**Dynamic Apps is a library, not a hosted AI-generated app deployment
...
isolated VM serving the generated application. Rivet handles request routing and
orchestrates the pool of prewarmed VMs.

<svg viewBox="0 0 620 190" role="img" aria-label="An HTTP request reaches your Hono server, where appsRouter uses Rivet to route it to a prewarmed isolated VM serving the AI-generated app." style="width:100%;height:auto;max-width:620px;display:block;margin:2.5rem auto 1rem;">
  <defs>
